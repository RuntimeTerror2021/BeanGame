...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  // code/big.js
  function a2() {
    let a4 = 0, b2 = false, c = 1;
    return { id: "big", require: ["scale"], update() {
      b2 && (a4 -= dt()) <= 0 && this.smallify(), this.scale = this.scale.lerp(vec2(c), 6 * dt());
    }, isBig: () => b2, smallify() {
      c = 1, a4 = 0, b2 = false;
    }, biggify(d) {
      c = 2, a4 = d, b2 = true;
  ...
  function loadAssets() {
    ...
    loadSprite("Red Bean", "sprites/red_bean.png");
    loadSprite("Orange Bean", "sprites/orange_bean.png");
    loadSprite("Yellow Bean", "sprites/yellow_bean.png");
    loadSprite("Green Bean", "sprites/green_bean.png");
    loadSprite("Cyan Bean", "sprites/cyan_bean.png");
    loadSprite("Blue Bean", "sprites/dark_blue_bean.png");
    loadSprite("Purple Bean", "sprites/purple_bean.png");
    loadSprite("Pink Bean", "sprites/pink_bean.png");
    loadSprite("Ink Bean", "sprites/ink_bean.png");
    loadSprite("Inverted Bean", "sprites/inverted_bean.png");
    ...
    loadSound("speed", "sounds/wooosh.mp3");
    loadSound("snore1", "sounds/snore1.mp3");
    loadSound("snore8", "sounds/snore8.mp3");
    loadSound("snore7", "sounds/snore7.mp3");
    loadSound("snore6", "sounds/snore6.mp3");
    loadSound("snore5", "sounds/snore5.mp3");
    loadSound("snore4", "sounds/snore4.mp3");
    loadSound("snore3", "sounds/snore3.mp3");
    loadSound("snore2", "sounds/snore2.mp3");
  }
  ...
  var MOVE_SPEED = 480;
  var FALL_DEATH = 2400;
  var toBool = /* @__PURE__ */ __name((string) => string === "true" ? true : false, "toBool");
  var f2 = toBool(localStorage["st2"]);
  ...
  if (k2 == localStorage.eggsFound.split(",").length) {
    ROCKUNLOCK = true;
  }
  var tempp = localStorage.eggsFound.split(",");
  ...
  scene("market", () => {
    ...
    let pr2 = [3, 3, 3, 3, 3, 3, 3, 3, 5, 5];
    let prs = [3e3, 3e3, 3e3, 3e3, 3e3, 3e3, 3e3, 3e3, 5e3, 5e3];
...
Julien Ayyad, Sebastian Jakubek, Olive Pollina`, { size: 35 }),
  ...
  scene("game", ({ levelId, coins } = { levelId: lvtx, coins: 0 }) => {
    ...
    const level = addLevel(LEVELS[lvlt != null ? lvlt : 0], levelConf);
